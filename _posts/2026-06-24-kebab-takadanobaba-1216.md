---
layout: post
title: "高田馬場で見つけたケバブのキッチンカー「PIKNIK」。名物のロングポテトを食べてみた"
date: 2026-06-24 12:16:00 +0900
category: ごはん
tags: [高田馬場, キッチンカー, ケバブ, ロングポテト, テイクアウト]
location: 東京都新宿区高田馬場
shop_name: PIKNIK KEBAB（ピクニックケバブ・キッチンカー）
hero: /assets/img/posts/2026-06-24-kebab-takadanobaba-1216/01.jpg
images:
...
看板にはケバブサンドやチーズドッグなど色々並んでいましたが、気になったのは名物っぽい「ロングポテト」。注文してみると、箱からはみ出すくらい長〜いポテトがどっさり出てきました。見た目のインパクトがすごくて、これは子どもが見たら絶対よろこぶやつです。

味付けは数種類から選べるスタイル。外はサクッと、中はほくっとした素朴なフライドポテトで、歩きながらつまむのにちょうどいい感じでした。

受け取った紙袋には「Piknik I♥Kitchen」のロゴと、トルコ・日本の国旗、そして大きく「Thank you!!」の文字。こういう遊び心も、キッチンカーならではで気分が上がります。

<div class="photo-gallery">
  {% for img in page.images %}
  <img src="{{ img | relative_url }}" alt="高田馬場のキッチンカー PIKNIK KEBAB" loading="lazy" decoding="async">
  {% endfor %}
</div>

キッチンカーなので、出店する場所や日時はその時々で変わります。テイクアウトで歩き食べできるので、子連れでも気軽。あの長いポテトを家族でシェアするのも楽しそうだなと思いながら、ぺろっといただきました。

<div class="shop-info">
  <h3>お店情報</h3>
  <dl>
    <dt>店名</dt><dd>{{ page.shop_name }}</dd>
    <dt>場所</dt><dd>{{ page.location }}（この日は高田馬場周辺に出店。キッチンカーのため出店場所は日によって変わります）</dd>
    <dt>カテゴリ</dt><dd>{{ page.category }}</dd>
    <dt>この日のメニュー</dt><dd>ロングポテト（ほかにケバブサンド・チーズドッグなど）</dd>
